...
//////////////////////////
// Putting refactors/bugs here!
//////////////////////////

//Refactored Embargo only adds 1 coin instead of 2
int playEmbargo(int handPos, int currentPlayer, struct gameState *state){
  int choice1 = 1;
  //+2 Coins
...
//Refactored village gives you your actions but does not draw a card
//because it was "accidentally" commented out
...
//Refactored Smithy! He will give us 4 cards instead of 3.
...
//The drawntreasure variable starts at 2 instead of 0, so the logic will assume
//we already had one drawn even through we didn't
int playAdventurer(int currentPlayer, int temphand[MAX_HAND], struct gameState *state){
  int cardDrawn;
  int drawntreasure = 2;
  int z = 0;
...
//END Bug creation
int playSalvager(int handPos, int currentPlayer, struct gameState *state){
  int choice1 = 1;
  //+1 buy
  state->numBuys++;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer:
      return playAdventurer(currentPlayer, temphand, state);
    ...
    case embargo:
      return playEmbargo(handPos, currentPlayer, state);
    ...
    case salvager:
      return playSalvager(handPos, currentPlayer, state);
